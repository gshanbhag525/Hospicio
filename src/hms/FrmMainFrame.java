...
public class FrmMainFrame extends JFrame
{
	...
	{
		btnChangePassword=new JButton(new ImageIcon(new ImageIcon("src/images/ChangePassword.png").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnAddUser=new JButton(new ImageIcon(new ImageIcon("src/images/AddUser.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnDoctors=new JButton(new ImageIcon(new ImageIcon("src/images/Doctors.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnPatients=new JButton(new ImageIcon(new ImageIcon("src/images/Patients.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnProcedure=new JButton(new ImageIcon(new ImageIcon("src/images/Procedure.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnMedicines=new JButton(new ImageIcon(new ImageIcon("src/images/Medicines.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnRoom=new JButton(new ImageIcon(new ImageIcon("src/images/Room.png").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnPrescriptionSlip=new JButton(new ImageIcon(new ImageIcon("src/images/PrescriptionSlip.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnPatientAdmission=new JButton(new ImageIcon(new ImageIcon("src/images/AddPatient.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnFinalBill=new JButton(new ImageIcon(new ImageIcon("src/images/FinalBill.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnLogOff=new JButton(new ImageIcon(new ImageIcon("src/images/LogOff.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnViewHelp=new JButton(new ImageIcon(new ImageIcon("src/images/ViewHelp.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnAboutUs=new JButton(new ImageIcon(new ImageIcon("src/images/AboutUs.png").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		...
		btnExit=new JButton(new ImageIcon(new ImageIcon("src/images/exit.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
...
class MyDesktopPane extends JDesktopPane
{
	...
	public void paintComponent(Graphics g)
	{
		...
		ImageIcon ii=new ImageIcon("src/images/png_main.png");
		Dimension d=getSize();
